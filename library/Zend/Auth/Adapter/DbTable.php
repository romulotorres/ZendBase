...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
    ...
    protected function _authenticateQuerySelect(Zend_Db_Select $dbSelect)
    {
        try {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Zend_Auth_Adapter_Exception('O sistema falhou ao tentar executar o script de autenticação. '
                                                . 'Por favor, entre em contato com o suporte '
                                                . 'e informe o ocorrido..', 0, $e);
        }
    ...
    protected function _authenticateValidateResultSet(array $resultIdentities)
    {
        ...
        if (count($resultIdentities) < 1) {
            ...
            $this->_authenticateResultInfo['messages'][] = 'Os dados informados não estão corretos.';
            return $this->_authenticateCreateAuthResult();
        } elseif (count($resultIdentities) > 1 && false === $this->getAmbiguityIdentity()) {
            $this->_authenticateResultInfo['code'] = Zend_Auth_Result::FAILURE_IDENTITY_AMBIGUOUS;
            $this->_authenticateResultInfo['messages'][] = 'Existe mais de um registro com estes dados, por favor, entre em contato com o suporte.';
            return $this->_authenticateCreateAuthResult();
        }
    ...
    protected function _authenticateValidateResult($resultIdentity)
    {
        ...
        if ($resultIdentity[$zendAuthCredentialMatchColumn] != '1') {
            ...
            $this->_authenticateResultInfo['messages'][] = 'Credencial inválida.';
            return $this->_authenticateCreateAuthResult();
        }
        ...
        $this->_authenticateResultInfo['messages'][] = 'Autenticado com sucesso.';
        return $this->_authenticateCreateAuthResult();
    }
